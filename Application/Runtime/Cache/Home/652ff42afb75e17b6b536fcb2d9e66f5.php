...
<div class="i_body p40 w100">
    <div class="w clearfix">
        ...
        <div class="tc clearfix">
            <img src="/sd/Public/template/img/shipower.jpg" alt="">
        </div>
        ...
        <div class="manr clearfix">
            ...
            <ul class="teacher clearfix">
                ...
                <?php if(is_array($cooker)): $i = 0; $__LIST__ = $cooker;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$cookers): $mod = ($i % 2 );++$i;?><li><a href="<?php echo U('home/cooker/cooker/id/'.$cookers['id']);?>"><img src="/sd/Public/<?php echo ($cookers["img"]); ?>"></a></li><?php endforeach; endif; else: echo "" ;endif; ?>
