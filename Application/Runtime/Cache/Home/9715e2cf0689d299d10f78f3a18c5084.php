...
<br>
<br>
<div class="col-lg-12" style="text-align: center;"><a class="btn btn-danger btn-rounded" ><?php echo ($sp_name); ?></a></div><br>
<br>
<br>
...
<p>
        <div class="col-lg-12">
            ...
            <form method="post" action="<?php echo U('home/Sp/province_statistics');?>">
            ...
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-title">
                    ...
                    <div>
                        ...
                        <a class="btn btn-rounded btn-outline btn-danger" href="<?php echo U('home/sp/province_statistics/name/创宏');?>">创宏</a>　　
                        <a class="btn btn-rounded btn-outline btn-danger" href="<?php echo U('home/sp/province_statistics/name/真趣');?>">真趣</a>　　
                        <a class="btn btn-rounded btn-outline btn-danger" href="<?php echo U('home/sp/province_statistics/name/鼎元离线1');?>">鼎元离线1</a>　　
                        <a class="btn btn-rounded btn-outline btn-danger" href="<?php echo U('home/sp/province_statistics/name/鼎元离线3');?>">鼎元离线3</a>　　
                        <a class="btn btn-rounded btn-outline btn-danger" href="<?php echo U('home/sp/province_statistics/name/鼎元离线5');?>">鼎元离线5</a>　　
                        <a class="btn btn-rounded btn-outline btn-danger" href="<?php echo U('home/sp/province_statistics/name/悦人爱城市');?>">悦人爱城市</a>　
                        <a class="btn btn-rounded btn-outline btn-danger" href="<?php echo U('home/sp/province_statistics/name/悦人');?>">悦人</a>　　
                        <a class="btn btn-rounded btn-outline btn-danger" href="<?php echo U('home/sp/province_statistics/name/龙腾');?>">龙腾</a>　　
                        <a class="btn btn-rounded btn-outline btn-danger" href="<?php echo U('home/sp/province_statistics/name/平治');?>">平治</a>　　
                        <a class="btn btn-rounded btn-outline btn-danger" href="<?php echo U('home/sp/province_statistics/name/百荣翼支付');?>">百荣翼支付</a>　　
                        <a class="btn btn-rounded btn-outline btn-danger" href="<?php echo U('home/sp/province_statistics/name/百荣空间');?>">百荣空间</a>　　
                        <a class="btn btn-rounded btn-outline btn-danger" href="<?php echo U('home/sp/province_statistics/name/星合');?>">星合</a>　　
                        <a class="btn btn-rounded btn-outline btn-danger" href="<?php echo U('home/sp/province_statistics/name/朗天');?>">朗天</a>　　
                        ...
                        <table class="table table-striped">
                            ...
                            <?php if(is_array($sp_statistics)): $i = 0; $__LIST__ = $sp_statistics;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$statistics): $mod = ($i % 2 );++$i;?><tr>
                                    <td><?php echo ($statistics["province"]); ?></td>
                                    <td><?php echo ($statistics["pay_num"]); ?></td>
                                    <td><?php echo ($statistics["recharge"]); ?></td>
                                    <td><?php echo ($statistics["year"]); ?>年<?php echo ($statistics["month"]); ?>月<?php echo ($statistics["day"]); ?>日</td>
