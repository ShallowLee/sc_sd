 ...
 <div class="row wrapper border-bottom white-bg page-heading">
    <div class="col-lg-10">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">
                 <a href="<?php echo U('home/front/index');?>">Package列表</a>
            </li>
        </ol>
    </div>
    <div class="col-lg-2">
                    ...
                    <div class="table-responsive">
                        <table class="table table-striped">
                            ...
                            <tr>
                                ...
                                <td colspan="10">
                                    <p class="pull-right"><button id="package_add" class="btn btn-primary pull-right">添加Package</button></p>
                            ...
                            <?php if(is_array($packages)): $i = 0; $__LIST__ = $packages;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$package): $mod = ($i % 2 );++$i;?><tr>
                                    </td>
	                                <td><?php echo ($package["id"]); ?></td>
	                                <td><?php echo ($package["name"]); ?></td>
                                        
                                    <td>
                                        <?php if ($package['cue']==0){?>
                                            <a class="btn btn-warning btn-rounded">已关闭</a>
                                        <?php } ?>
                                        <?php if ($package['cue']==1){ ?>
                                    ...
                                    <td>
                                        <?php if ($package['on_off']==0){?>
                                            <a class="btn btn-warning btn-rounded">已关闭</a>
                                        <?php } ?>
                                        <?php if ($package['on_off']==1){ ?>
                                            <a class="btn btn-primary btn-rounded">
                                              已开启
                                            </a>
                                        <?php } ?>
                                    </td>
                                    <td><?php echo (date("Y-m-d H:i:s",$package["create_time"])); ?></td>
	                                <td>
                                        <?php if($package['cue']==1): ?><a class="btn btn-xm btn-danger add_product" href="<?php echo U('home/package/cue/id/'.$package['id']);?>">提示关闭 </a>
                                        <?php else: ?>
                                            <a class="btn btn-xm btn-success add_product" href="<?php echo U('home/package/cue/id/'.$package['id']);?>">提示开启</a><?php endif; ?>  
                                        　　 | 　
                                        <?php if($package['on_off']==1): ?><a class="btn btn-xm btn-danger add_product" href="<?php echo U('home/package/on_off/id/'.$package['id']);?>">开关关闭 </a>
                                        <?php else: ?>
                                            <a class="btn btn-xm btn-success add_product" href="<?php echo U('home/package/on_off/id/'.$package['id']);?>">开关开启</a><?php endif; ?>
                                         　 | 　
                                        
                                        <a class="btn btn-xm btn-danger" href="<?php echo U('home/package/delete/id/'.$package['id']);?>">删除</a>
                                    </td>
