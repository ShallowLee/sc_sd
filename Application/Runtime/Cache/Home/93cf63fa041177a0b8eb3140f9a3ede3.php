...
<?php if(is_array($project_nav)): $i = 0; $__LIST__ = $project_nav;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$project_navs): $mod = ($i % 2 );++$i;?><a href="http://p.qiao.baidu.com/im/index?siteid=5367383&ucid=6948249&cp=lxxcpx.com&cr=&cw=" target="_self"><img src="/sd/Public/<?php echo ($project_navs["img"]); ?>"></a>　<?php endforeach; endif; else: echo "" ;endif; ?>
...
<div class="i_body p40 w100">
    ...
    <div class="w clearfix">
        ...
        <ul class="llist clearfix">
            ...
            <?php if(is_array($project_nav)): $i = 0; $__LIST__ = $project_nav;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$project_navs): $mod = ($i % 2 );++$i;?><li><a  href="<?php echo U('home/project/index/classify/'.$project_navs['id']);?>" target="_self"><?php echo ($project_navs["name"]); ?></a></li>　<?php endforeach; endif; else: echo "" ;endif; ?>
        </ul>
        ...
        <div class="manr clearfix">
            ...
            <ul class="px_ul clearfix">
                ...
                <?php if(is_array($food)): $i = 0; $__LIST__ = $food;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$foods): $mod = ($i % 2 );++$i;?><li><a href="<?php echo U('home/project/food/id/'.$foods['id']);?>"><img src="/sd/Public/<?php echo ($foods["img"]); ?>"><p><?php echo ($foods["name"]); ?></p></a></li><?php endforeach; endif; else: echo "" ;endif; ?>
