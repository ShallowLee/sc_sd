 ...
 <div class="row wrapper border-bottom white-bg page-heading">
    <div class="col-lg-10">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">
                 <a href="<?php echo U('home/front/index');?>">Order_Log列表</a>
            </li>
        </ol>
    </div>
    <div class="col-lg-2">
                    ...
                    <div class="table-responsive">
                        <table class="table table-striped">
                            ...
                            <tr>
                                <th width="150">编号</th>
                                <th>最后打印时间</th>
                                <th width="500">return_log</th>
                                <th width="500">get_log</th>
                            ...
                            <?php if(is_array($log)): $i = 0; $__LIST__ = $log;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$logs): $mod = ($i % 2 );++$i;?><tr>
                                    ...
                                    <td><?php echo ($logs["return_log"]); ?></td>
                                    <td><?php echo ($logs["get_log"]); ?></td>
