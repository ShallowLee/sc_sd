...
<div class="i_body p40 w100">
    <div class="w clearfix">
        ...
        <div class="manr clearfix">
            ...
            <div id="art_title"><h2><?php echo ($cooker["cooker"]); ?></h2></div>
            <div id="art_xinxi">
                <span>时间：<?php echo ($cooker["time"]); ?></span>
                <span>来源：<?php echo ($cooker["source"]); ?></span>
                <span>点击：<?php echo ($cooker["click"]); ?>次</span>
            </div>
            <div id="art_content">
                <div id="MyContent">
                    <a href="javascript:;" onclick="showimg('/UploadFiles/2017-01/2017010314370114796.gif');">
                        <img src="/sd/Public/<?php echo ($cooker["img"]); ?>" alt="林平俊" onmousewheel="return bbimg(this)" onload="javascript:resizepic(this)" border="0"/>
                    </a></div>
