...
<div class="i_body p40 w100">
    <div class="w clearfix">
        ...
        <ul class="llist clearfix">
            ...
            <li><a  href="/Item/list.asp?id=1661" target="_self">优秀学员</a></li>
        ...
        <div class="seccess p2 clearfix">
            <div class="w clearfix" id="seccess">
                ...
                <ul class="seccess_yuan clearfix">
                    ...
                    <?php if(is_array($student)): $i = 0; $__LIST__ = $student;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$students): $mod = ($i % 2 );++$i;?><li><a href="<?php echo U('home/student/student/id/'.$students['id']);?>"><img src="/sd/Public/<?php echo ($students["img"]); ?>"></a><p><?php echo ($students["name"]); ?></p></li><?php endforeach; endif; else: echo "" ;endif; ?>
