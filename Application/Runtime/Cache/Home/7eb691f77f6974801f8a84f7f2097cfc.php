...
<?php if(is_array($cooker)): $i = 0; $__LIST__ = $cooker;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$cookers): $mod = ($i % 2 );++$i;?><li><a href="<?php echo U('home/cooker/index/id/'.$cookers['id']);?>"><img width="210" height="296" src="/sd/Public/<?php echo ($cookers["img"]); ?>"></a></li><?php endforeach; endif; else: echo "" ;endif; ?>
