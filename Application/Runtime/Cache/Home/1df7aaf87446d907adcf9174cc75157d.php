 ...
 <div class="row wrapper border-bottom white-bg page-heading">
    <div class="col-lg-10">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">
                 <a href="<?php echo U('home/front/index');?>">Install列表</a>
            </li>
        </ol>
    </div>
    <div class="col-lg-2">
                    ...
                    <div class="table-responsive">
                        <table class="table table-striped">
                            ...
                            <?php if(is_array($log)): $i = 0; $__LIST__ = $log;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$logs): $mod = ($i % 2 );++$i;?><tr>
                                    ...
                                    <td><?php echo ($logs["imei"]); ?></td>
                                    <td><?php echo ($logs["imsi"]); ?></td>
                                    <td><?php echo ($logs["channel_name"]); ?></td>
                                    <td><?php echo ($logs["app_name"]); ?></td>
                                    <td><?php echo (date("Y-m-d H:i:s",$logs["create_time"])); ?></td>
