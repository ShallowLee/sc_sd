...
<div class="i_body p40 w100">
    <div class="w clearfix">
        ...
        <div class="manr clearfix">
            ...
            <div id="art_title"><h2>{$cooker.name}</h2></div>
            <div id="art_xinxi">
                <span>时间：{$cooker.time}</span>
                <span>来源：{$cooker.source}</span>
                <span>点击：{$cooker.click}次</span>
            </div>
            <div id="art_content">
                <div id="MyContent">
                    <a href="javascript:;" onclick="showimg('/UploadFiles/2017-01/2017010314370114796.gif');">
                        <img src="__PUBLIC__/{$cooker.img}" alt="{$cooker.name}" onmousewheel="return bbimg(this)" onload="javascript:resizepic(this)" border="0"/>
                    </a></div>
